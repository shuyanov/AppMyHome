                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        width: size.width,
                        child: ElevatedButton(
                            child: Text("За республиканцев"), onPressed: () {}),
                      ),
                    ],
                  ),
                )
          ...
          onPressed: () {
            ...
            showDialog(
              ...
              builder: (BuildContext context) {
                return Container(
                    padding: EdgeInsets.only(bottom: 300, top: 120),
                          ...
                          TextButton(
                              onPressed: () {
                                showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return Container(
                                        padding: EdgeInsets.only(bottom: 300, top: 100),
                                          child: AlertDialog(
                                              shape: RoundedRectangleBorder(
                                                  borderRadius: BorderRadius.all(Radius.circular(32.0))),
                              ...
                              builder: (BuildContext context) {
                                return Container(
                                  child: AlertDialog(
                                    ...
                                    content: Column(
                                      children: [
                                        Text("Qustions", style: TextStyle(color: Colors.blueAccent),),
                                        TextField(
                                          decoration: InputDecoration(
                                            hintText: hn,
                                          ),
                                        ...
                                        Text("Response options", style: TextStyle(color: Colors.blueAccent)),
                                        TextField(
                                          decoration: InputDecoration(
                                            hintText: ro,
                                          ),
                                        ...
                                        //Где-то здесь должна быть функция для добавления вариантов опроса
                                        TextField(
                                          decoration: InputDecoration(
                                            hintText:
                                            "Количество выборок",
                                          ),
                                          controller: ControlCount,
                                          onChanged: (countStr) {
